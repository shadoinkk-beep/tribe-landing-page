  ...
  return (
    ...
    <section className="container_content grid  gap-8">
      ...
      <div className="max-w-6xl mx-auto grid grid-cols-1 md:grid-cols-9 gap-3">
        {/* Row 1 */}
        <motion.div
          className="md:col-span-5 bg-[#4B3D1A] text-white rounded-2xl overflow-hidden shadow-md relative h-96"
        ...
        <motion.div
          className="bg-[#4B3D1A] text-white rounded-2xl p-6 shadow-md grid md:col-span-4 h-96"
          initial={{ opacity: 0, y: 50 }}
          whileInView={{ opacity: 1, y: 0 }}
